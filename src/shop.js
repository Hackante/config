...
module.exports.items = [
  ...
  { id: "description", name: "Description", price: 25, currency: "roses", description: "Customize your profile description!" },
  ...
  { id: "normal", name: "Normal Item Roulette", price: 10, currency: "coins", description: "Gain access to the item roulette channels to get color roles", role: "606123668162084894", response: "You now have access to the item roulette channels! Use ,ir to use the roulette." },
  ...
  { id: "lottery", name: "Lottery ticket", price: 20, currency: "coins", description: "Get a ticket to take part in the lottery!", role: "947629828771831888", response: "You can now entry lottery giveaways 🥳"}
]
